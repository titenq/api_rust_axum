...
use crate::{
    error::MyError,
    models::{note_model::NoteModel, user_model::UserModel},
};
...
pub struct DB {
    ...
    pub user_document: Collection<Document>,
}
...
impl DB {
    pub async fn init() -> Result<Self> {
        ...
        let user_document: Collection<Document> = database.collection::<Document>("users");
